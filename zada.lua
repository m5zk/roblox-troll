...
-- New: Crazy Announcement button in Misc - sends a chat message to all players: "Mzee34k Dev en RGB"
...
UserInputService.InputBegan:Connect(function(input, gameProcessed)
    if SettingKeybind and input.KeyCode ~= Enum.KeyCode.Unknown then
        ...
        -- Update button text (you may need to refresh buttons or store references)
        SettingKeybind = nil
        return
    end
